...
namespace UseTax_Disptacher
{
    ...
    {
        private Lazy<global::UseTax_Disptacher.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::UseTax_Disptacher.WorkflowRunnerService>(() => new global::UseTax_Disptacher.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::UseTax_Disptacher.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
